...
#define NODE_MAIN_LOGGER_NAME "tf_broadcaster_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_pkg.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_pkg::TfBroadcasterNode>";
